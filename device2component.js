...
let indexString = '// DO NOT EDIT THIS FILE. IT IS AUTOMATICALLY GENERATED BY device2component.js\n\n';
  ...
  fs.readdir(exportDir, (err, files) => {
    ...
    files.filter((file) => (file.endsWith('.export.json'))  && file !== 'dependencies.json'  && file !== 'rnboDevices.json').forEach((file) => {
      ...
      fs.readFile(filePath, 'utf8', (err, data) => {
        ...
        // add component to index.js
        // makeIndex('append', file.split('.export.json')[0]) 

        // indexString = indexString + `export { default as '${file.split('.export.json')[0]}' } from './${file.split('.export.json')[0]}';\n`
